...
from mvn.models.DGLifting_rgbflow_single import RGBFlowSinglePointLifting


class RGBFlowPoseSingle(nn.Module):
    def __init__(self, config, device="cuda:0"):
        ...
        if config.model.backbone.type in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("RGBFlowPoseSingle currently supports HRNet backbones only.")
        ...
        self.Lifting_net = RGBFlowSinglePointLifting(
    ...
    def forward(self, images, keypoints_2d_cpn, keypoints_2d_cpn_crop, flow_images):
        ...
        keypoints_3d = self.Lifting_net(keypoints_2d_cpn, keypoints_2d_cpn_crop, flow_images, features_list)
