...
class FlowMFCE(nn.Module):
    """Independent motion-field adaptive sampling branch for optical-flow features."""
...
class RGBFlowMFCESeparateLifting(nn.Module):
    def __init__(
        self,
        config=None,
        backbone="hrnet_32",
        ...
        if backbone in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("Unsupported backbone for RGBFlowMFCESeparateLifting: {}".format(backbone))
