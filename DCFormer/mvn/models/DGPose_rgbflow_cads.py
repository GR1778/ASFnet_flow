...
from mvn.models.DGLifting_rgbflow_cads import RGBFlowCADSLifting


class RGBFlowPoseCADS(nn.Module):
    def __init__(self, config, device="cuda:0"):
        ...
        if config.model.backbone.type in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("RGBFlowPoseCADS currently supports HRNet backbones only.")
        ...
        self.Lifting_net = RGBFlowCADSLifting(
