...
from mvn.models.DGLifting_depthflow_dlst import DepthFlowDLSTLifting


class DepthFlowPoseDLST(nn.Module):
    def __init__(self, config, device="cuda:0"):
        ...
        if config.model.backbone.type in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("DepthFlowPoseDLST currently supports HRNet backbones only.")
        ...
        self.Lifting_net = DepthFlowDLSTLifting(config.model.poseformer)

    def forward(self, images, keypoints_2d_cpn, keypoints_2d_cpn_crop, depth_images, flow_images):
        ...
        return self.Lifting_net(
            keypoints_2d_cpn,
            keypoints_2d_cpn_crop,
            depth_images,
            flow_images,
            features_list_hr,
        )
