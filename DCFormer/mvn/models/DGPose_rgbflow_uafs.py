...
from mvn.models.DGLifting_rgbflow_uafs import RGBFlowUAFSLifting


class RGBFlowPoseUAFS(nn.Module):
    def __init__(self, config, device="cuda:0"):
        ...
        if config.model.backbone.type in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("RGBFlowPoseUAFS currently supports HRNet backbones only.")
        ...
        self.Lifting_net = RGBFlowUAFSLifting(
    ...
    def forward(self, images, keypoints_2d_cpn, keypoints_2d_cpn_crop, flow_images):
        ...
        keypoints_3d, _ = self.Lifting_net(
            keypoints_2d_cpn,
