...
from mvn.models.DGLifting_rgbflow_mfas import RGBFlowMFASLifting


class RGBFlowPoseMFAS(nn.Module):
    def __init__(self, config, device="cuda:0"):
        ...
        if config.model.backbone.type in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("RGBFlowPoseMFAS currently supports HRNet backbones only.")
        ...
        self.Lifting_net = RGBFlowMFASLifting(
