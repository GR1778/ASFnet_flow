...
from mvn.models.DGLifting_rgbflow_mces import RGBFlowMCESLifting


class RGBFlowPoseMCES(nn.Module):
    def __init__(self, config, device="cuda:0"):
        ...
        if config.model.backbone.type in ["hrnet_32", "hrnet_48"]:
            ...
            raise ValueError("RGBFlowPoseMCES currently supports HRNet backbones only.")
        ...
        self.Lifting_net = RGBFlowMCESLifting(
