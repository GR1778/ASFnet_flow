...
from mvn.models.DGLifting_dlst_ude import DGLifting


class DepthGuidedPoseDLSTUDE(nn.Module):
    """Parallel DLST + UDE fusion: keeps UDE's BNN supervision and DLST's
    ordering supervision. Lifting net forward returns
