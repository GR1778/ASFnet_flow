...
from mvn.models.DGLifting_rdga_cmfr import DGLiftingRDGACMFR


class DepthGuidedPoseRDGACMFR(nn.Module):
    def __init__(self, config, device='cuda:0'):
        ...
        self.Lifting_net = DGLiftingRDGACMFR(config.model.poseformer)
